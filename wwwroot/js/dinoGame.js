...
function updateGameArea() {
    ...
    if (myGameArea.frameNo == 1 || everyinterval(150)) {
        ...
        if (result == 1) {
            ...
            // myObstacles.push(new component(10, height, "https://localhost:44302/images/earth-globe.png", x, 0, "image"));
            myObstacles.push(new component(70, 80, "https://localhost:44302/images/LYB.png", x, 330, "image"));
            // myObstacles.push(new component(10, x - height - gap, "https://localhost:44302/images/earth-globe.png", x, height + gap, "image"));
            myObstacles.push(new component(70, x - 80 - gap, "https://localhost:44302/images/LYB.png", x, height + gap, "image"));
        }
    }
    for (i = 0; i < myObstacles.length; i += 1) {
        myObstacles[i].x += -2;
